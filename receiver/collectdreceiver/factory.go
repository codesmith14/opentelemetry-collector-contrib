...
const (
	...
	// TODO: check what gateway defaults to
	defaultBindEndpoint = "127.0.0.1:8081"
...
func (f *Factory) CreateMetricsReceiver(
	...
	rCfg := cfg.(*Config)
	return New(logger, rCfg.Endpoint, rCfg.Timeout, rCfg.DefaultLabelsPrefix, nextConsumer)
}
